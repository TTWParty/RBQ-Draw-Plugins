...
- **🌟 发布 V27 全场景通用自适应旗舰版 System Prompt**：
  - **彻底解决 POV / 被动互动肢体融合与异形**：智能识别主观视角（用户/第一视角主角躺着、被观察、被骑乘等），将入镜肢体（如 `pov_hands, pov_penis`）直接写入 `scene`，严禁为主观观察者创建独立 Character 实体，杜绝双重躯体与肉体重叠畸形。
  - **彻底废除僵硬机械的“三层景深公式”**：取消刻板的 Foreground/Middle/Background 机械拼凑，解决近景特写中强塞杂物挡脸的顽疾。
  - **修复负面词（UC）误杀面部 Bug**：确立终极防破图铁律，严禁在有角色面部描写的场景中向 UC 误填 `face, head, upper_body`。
  - **全场景自适应构图决策**：针对单人肖像特写、主观第一人称 POV、双人/多人互动、亲密性爱（NSFW 标准体位与体液流转）、宏大战斗大场景等提供全方位高审美支持。
  - **深度适配 NovelAI V5 / V4.5 美学规范**：全面对齐 V5 官方推荐出图标准，消除 3D 假人恐怖谷效应。
