    ...
    function renderSettings(panel) {
        ...
        container.innerHTML = `
            ...
            <div class="st-scene-trigger-modal-grid">
                ...
                <label class="st-scene-trigger-field" title="选择前情增强分析版本。V1~V4: payload 字段注入英文指令。V5: 额外 system prompt 注入中文 6 维状态快照分析。"><span>前情增强分析</span><select id="rbq-sdt-enhanced-context"><option value="off">关闭</option><option value="v1">V1 · 隐式分析 (v4.1.10)</option><option value="v2">V2 · 时间线定位 (v4.2.6)</option><option value="v3">V3 · 5维分析 (v4.2.7a)</option><option value="v4">V4 · 分析导向 (v4.2.7b)</option><option value="v5">V5 · 状态快照 (v4.2.7c)</option></select></label>
